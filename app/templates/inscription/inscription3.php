...
<div id="wrapper" class="wrappInscr container">
	<form method="POST" class="col-md-12">  
		...
		<div class="col-md-10 col-md-offset-1">
			...
			<div class="row form-group">
				<div class="col-md-6 col-xs-6 col-sm-6">
					<div class="col-md-12 col-md-offset-0">
						...
						<div class="col-md-8">
							<label for="psn" class="col-md-2 control-label celSoc">Steam</label>
				...
				<div class="col-md-6 col-xs-6 col-sm-6">
					<div class="col-md-12 col-md-offset-0">
						...
						<div class="col-md-8">
							<label for="xbox" class="col-md-2 control-label celSoc">Battle.net</label>
			...
			<div class="row form-group">
				<img class="icons col-md-2" src="<?= $this->assetUrl('img/icons/Xbox_logo.png') ?>">
				<label for="xbox" class="col-md-2 control-label celSoc">XboxLive</label>
				<div class="col-md-8">
			...
			<div class="row form-group">
				<img class="icons col-md-2" src="<?= $this->assetUrl('img/icons/Steam_logo.png') ?>">
			...
			<div class="row form-group">
				<img class="icons col-md-2" src="<?= $this->assetUrl('img/icons/battlenet_logo.png') ?>">
			...
			<div class="row form-group">
				<img class="icons col-md-2" src="<?= $this->assetUrl('img/icons/nintendo_logo.png') ?>">
			...
			<div class="row form-group">
				<img class="icons col-md-2" src="<?= $this->assetUrl('img/icons/origin1_logo.png') ?>">
		...
		<div class="col-md-10 col-md-offset-1">
			...
			<div class="row form-group">
				<img class="icons col-md-2" src="<?= $this->assetUrl('img/icons/linkedin_logo.png') ?>">
			...
			<div class="row form-group">
				<img class="icons col-md-2" src="<?= $this->assetUrl('img/icons/viadeo_logo.png') ?>">
			...
			<div class="row form-group">
				<img class="icons col-md-2" src="<?= $this->assetUrl('img/icons/xing_logo.png') ?>">
			...
			<div class="row form-group">
				<img class="icons col-md-2" src="<?= $this->assetUrl('img/icons/muxi_logo.jpg') ?>">
			...
			<div class="row form-group">
				<img class="icons col-md-2" src="<?= $this->assetUrl('img/icons/github_logo.png') ?>">
		...
		<div class="col-md-10 col-md-offset-1">
			...
			<div class="row form-group">
				<img class="icons col-md-2" src="<?= $this->assetUrl('img/icons/FB_logo.png') ?>">
			...
			<div class="row form-group">
				<img class="icons col-md-2" src="<?= $this->assetUrl('img/icons/Twitter-logo.png') ?>">
			...
			<div class="row form-group">
				<img class="icons col-md-2" src="<?= $this->assetUrl('img/icons/YouTube-logo.png') ?>">
			...
			<div class="row form-group">
				<img class="icons col-md-2" src="<?= $this->assetUrl('img/icons/googleplus_logo.png') ?>">
			...
			<div class="row form-group">
				<img class="icons col-md-2" src="<?= $this->assetUrl('img/icons/Skype_logo.png') ?>">
			...
			<div class="row form-group">
				<img class="icons col-md-2" src="<?= $this->assetUrl('img/icons/instagram_logo.png') ?>">
			...
			<div class="row form-group">
				<img class="icons col-md-2" src="<?= $this->assetUrl('img/icons/Whatsapp_logo.png') ?>">
			...
			<div class="row form-group">
				<img class="icons col-md-2" src="<?= $this->assetUrl('img/icons/pinterest-logo.png') ?>">
			...
			<div class="row form-group">
				<img class="icons col-md-2" src="<?= $this->assetUrl('img/icons/Deezer_logo.png') ?>">
			...
			<div class="row form-group">
				<img class="icons col-md-2" src="<?= $this->assetUrl('img/icons/Spotify_logo.png') ?>">
			...
			<div class="row form-group">
				<img class="icons col-md-2" src="<?= $this->assetUrl('img/icons/Viber-logo.png') ?>">
