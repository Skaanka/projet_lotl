...
<div id="wrapper" class="wrappInscr container">
	<form method="POST" class="col-md-12">  
		...
		<div class="col-md-offset-0 text-center">
			<h1 class="title_inscipt col-md-4 col-md-offset-4 text-center">Réseaux Sociaux</h1><br/>
		</div>


		<div class="col-md-10 col-md-offset-1 espacement2">

			<div class=""><legend><h3 class="text-center">Divertissement</h3></legend></div>


			<div class="row form-group">
				<div class="col-md-6 col-xs-6 col-sm-6">
					<div class="col-md-12 col-md-offset-0">
						<img class="icons col-md-3 col-xs-5 img-responsive" src="<?= $this->assetUrl('img/icons/PSN_logo.png') ?>" alt="logo psn">
				...
				<div class="col-md-6 col-xs-6 col-sm-6">
					<div class="col-md-12 col-md-offset-0">
						<img class="icons col-md-3 col-xs-5 img-responsive" src="<?= $this->assetUrl('img/icons/Xbox_logo.png') ?>">
						<div class="col-md-8 col-xs-12">
			...
			<div class="row form-group">
				<div class="col-md-6 col-xs-6 col-sm-6">
					<div class="col-md-12 col-md-offset-0">
						<img class="icons col-md-3 col-xs-5" src="<?= $this->assetUrl('img/icons/Steam_logo.png') ?>">
						<div class="col-md-8 col-xs-12">
				...
				<div class="col-md-6 col-xs-6 col-sm-6">
					<div class="col-md-12 col-md-offset-0">
						<img class="icons col-md-3 col-xs-5" src="<?= $this->assetUrl('img/icons/battlenet_logo.png') ?>">
						<div class="col-md-8 col-xs-12">
			...
			<div class="row form-group">
				<div class="col-md-6 col-xs-6 col-sm-6">
					<div class="col-md-12 col-md-offset-0">
						<img class="icons col-md-3 col-xs-5" src="<?= $this->assetUrl('img/icons/nintendo_logo.png') ?>">
						<div class="col-md-8 col-xs-12">
				...
				<div class="col-md-6 col-xs-6 col-sm-6">
					<div class="col-md-12 col-md-offset-0">
						<img class="icons col-md-3 col-xs-5" src="<?= $this->assetUrl('img/icons/origin1_logo.png') ?>">
						<div class="col-md-8 col-xs-12">
		...
		<div class="col-md-10 col-md-offset-1 espacement2">
			...
			<div class=""><legend><h3 class="text-center">Réseaux Pro.</h3></legend></div>

            
            <div class="row form-group">
				<div class="col-md-6 col-xs-6 col-sm-6">
					<div class="col-md-12 col-md-offset-0">
						<img class="icons col-md-3 col-xs-5" src="<?= $this->assetUrl('img/icons/linkedin_logo.png') ?>">
						<div class="col-md-8 col-xs-12">
				...
				<div class="col-md-6 col-xs-6 col-sm-6">
					<div class="col-md-12 col-md-offset-0">
						<img class="icons col-md-3 col-xs-5" src="<?= $this->assetUrl('img/icons/viadeo_logo.png') ?>">
						<div class="col-md-8 col-xs-12">
            ...
            <div class="row form-group">
				<div class="col-md-6 col-xs-6 col-sm-6">
					<div class="col-md-12 col-md-offset-0">
						<img class="icons col-md-3 col-xs-5" src="<?= $this->assetUrl('img/icons/xing_logo.png') ?>">
						<div class="col-md-8 col-xs-12">
				...
				<div class="col-md-6 col-xs-6 col-sm-6">
					<div class="col-md-12 col-md-offset-0">
						<img class="icons col-md-3 col-xs-5" src="<?= $this->assetUrl('img/icons/muxi_logo.jpg') ?>">
						<div class="col-md-8 col-xs-12">
            ...
            <div class="row form-group">
				<div class="col-md-6 col-xs-6 col-sm-6">
					<div class="col-md-12 col-md-offset-0">
						<img class="icons col-md-3 col-xs-5" src="<?= $this->assetUrl('img/icons/github_logo.png') ?>">
						<div class="col-md-8 col-xs-12">
		...
		<div class="col-md-10 col-md-offset-1 espacement2">
			...
			<div class=""><legend><h3 class="text-center">Réseaux Sociaux</h3></legend></div>

            
            <div class="row form-group">
				<div class="col-md-6 col-xs-6 col-sm-6">
					<div class="col-md-12 col-md-offset-0">
						<img class="icons col-md-3 col-xs-5" src="<?= $this->assetUrl('img/icons/FB_logo.png') ?>">
						<div class="col-md-8 col-xs-12">
				...
				<div class="col-md-6 col-xs-6 col-sm-6">
					<div class="col-md-12 col-md-offset-0">
						<img class="icons col-md-3 col-xs-5" src="<?= $this->assetUrl('img/icons/Twitter-logo.png') ?>">
						<div class="col-md-8 col-xs-12">
            ...
            <div class="row form-group">
				<div class="col-md-6 col-xs-6 col-sm-6">
					<div class="col-md-12 col-md-offset-0">
						<img class="icons col-md-3 col-xs-5" src="<?= $this->assetUrl('img/icons/YouTube-logo.png') ?>">
						<div class="col-md-8 col-xs-12">
				...
				<div class="col-md-6 col-xs-6 col-sm-6">
					<div class="col-md-12 col-md-offset-0">
						<img class="icons col-md-3 col-xs-5" src="<?= $this->assetUrl('img/icons/googleplus_logo.png') ?>">
						<div class="col-md-8 col-xs-12">
            ...
            <div class="row form-group">
				<div class="col-md-6 col-xs-6 col-sm-6">
					<div class="col-md-12 col-md-offset-0">
						<img class="icons col-md-3 col-xs-5" src="<?= $this->assetUrl('img/icons/Skype_logo.png') ?>">
						<div class="col-md-8 col-xs-12">
				...
				<div class="col-md-6 col-xs-6 col-sm-6">
					<div class="col-md-12 col-md-offset-0">
						<img class="icons col-md-3 col-xs-5" src="<?= $this->assetUrl('img/icons/instagram_logo.png') ?>">
						<div class="col-md-8 col-xs-12">
            ...
            <div class="row form-group">
				<div class="col-md-6 col-xs-6 col-sm-6">
					<div class="col-md-12 col-md-offset-0">
						<img class="icons col-md-3 col-xs-5" src="<?= $this->assetUrl('img/icons/Whatsapp_logo.png') ?>">
						<div class="col-md-8 col-xs-12">
				...
				<div class="col-md-6 col-xs-6 col-sm-6">
					<div class="col-md-12 col-md-offset-0">
						<img class="icons col-md-3 col-xs-5" src="<?= $this->assetUrl('img/icons/pinterest-logo.png') ?>">
						<div class="col-md-8 col-xs-12">
            ...
            <div class="row form-group">
				<div class="col-md-6 col-xs-6 col-sm-6">
					<div class="col-md-12 col-md-offset-0">
						<img class="icons col-md-3 col-xs-5" src="<?= $this->assetUrl('img/icons/Deezer_logo.png') ?>">
						<div class="col-md-8 col-xs-12">
				...
				<div class="col-md-6 col-xs-6 col-sm-6">
					<div class="col-md-12 col-md-offset-0">
						<img class="icons col-md-3 col-xs-5" src="<?= $this->assetUrl('img/icons/Spotify_logo.png') ?>">
						<div class="col-md-8 col-xs-12">
            ...
            <div class="row form-group">
				...
				<div class="col-md-6 col-xs-6 col-sm-6">
					<div class="col-md-12 col-md-offset-0">
						<img class="icons col-md-3 col-xs-5" src="<?= $this->assetUrl('img/icons/Viber-logo.png') ?>">
						<div class="col-md-8 col-xs-12">
		...
		<legend><div id="" class="row">
			<div class="">
				<input type="submit" class="btn-navbut btn btn-primary col-md-offset-3 col-xs-offset-3 marginTop5Bottom10" value="Page précédente" name="precedent2">
				<input type="submit" class="btn btn-success col-md-offset-3 col-xs-offset-3 marginTop5Bottom10" value="valider" name="valider">
			</div>
		</div>
            </legend>
