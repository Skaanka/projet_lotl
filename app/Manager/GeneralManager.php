...
class GeneralManager extends \W\Manager\Manager {
    ...
    public function findUserAll($orderBy = "", $orderDir = "ASC") {
        ...
        $sql = "SELECT \n"
            . "	w.id, w.prenom, w.nom, w.ddn, w.mail, w.ddn, w.avatar, validation_inscription, w.adresse, w.cp, w.ville, w.phone, w.siteWeb, w.citation, w.statut, c.*, d.*, x.*, fl.*, p.*, rd.*, rp.*, rs.*"
            . "FROM \n"
            . "	`wusers` AS w \n"
